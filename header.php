...
<head>
    ...
    <meta name="description" content="Desarrollo web, portafolio y blog de programación. Un lugar dónde compartir la experiencia que he ido adquiriendo durante algún tiempo.">
...
<body <?php body_class(); frontPageFeaturedBody(); ?> >
    ...
    <!-- Google Tag Manager -->
        <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-WC3X7S"
        height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
        j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
        '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        })(window,document,'script','dataLayer','GTM-WC3X7S');</script>
